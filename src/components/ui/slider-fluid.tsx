...
const SliderFluid = forwardRef<HTMLDivElement, SliderFluidProps>(
  (
    {
      value,
      onChange,
        ...
        >
          ...
          >
            ...
            >
              ...
              {!hideFill && (
              <motion.div
                className={cn("absolute h-full bg-accent/40", fillClassName)}
                style={{
                  left: fillLeft,
                  width: fillWidth,
                  ...fillStyle,
...
SliderFluid.displayName = "SliderFluid";
...
export { SliderFluid, SliderComfortable };
export type { SliderFluidProps, SliderValue, ValuePosition, SliderComfortableProps };
