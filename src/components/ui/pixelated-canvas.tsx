...
import type {
  ...
  PixelatedCanvasSample,
} from "@/components/ui/pixelated-canvas-types"
...
export const PixelatedCanvas: React.FC<PixelatedCanvasProps> = ({
  ...
  const samplesRef = React.useRef<PixelatedCanvasSample[]>([])
