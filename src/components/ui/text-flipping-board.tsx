...
import type { TextFlippingBoardProps, AccentColor, ParsedCell } from "./text-flipping-board-types";

const FLAP_CHARS = " ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789!@#$()-+&=;:'\"%,./?Â°";
...
const ColorCell = React.memo(function ColorCell({ color }: ColorCellProps) {
  return (
    <div
