...
interface TabsSubtleFluidContextValue {
...
const TabsSubtleFluidContext =
  createContext<TabsSubtleFluidContextValue | null>(null);

function useTabsSubtleFluid() {
  const ctx = useContext(TabsSubtleFluidContext);
  if (!ctx) throw new Error("useTabsSubtleFluid must be used within a TabsSubtleFluid");
  return ctx;
}

interface TabsSubtleFluidProps
...
const TabsSubtleFluid = forwardRef<HTMLDivElement, TabsSubtleFluidProps>(
  (
    {
      children,
      selectedIndex,
    ...
    return (
      <TabsSubtleFluidContext.Provider
...
TabsSubtleFluid.displayName = "TabsSubtleFluid";

interface TabsSubtleFluidItemProps extends HTMLAttributes<HTMLButtonElement> {
  icon?: IconComponent;
  label: string;
  index: number;
}

const TabsSubtleFluidItem = forwardRef<HTMLButtonElement, TabsSubtleFluidItemProps>(
...
TabsSubtleFluidItem.displayName = "TabsSubtleFluidItem";

interface TabsSubtleFluidPanelProps extends HTMLAttributes<HTMLDivElement> {
  index: number;
  selectedIndex: number;
  idPrefix: string;
  children: ReactNode;
...
const TabsSubtleFluidPanel = forwardRef<HTMLDivElement, TabsSubtleFluidPanelProps>(
...
TabsSubtleFluidPanel.displayName = "TabsSubtleFluidPanel";

export { TabsSubtleFluid, TabsSubtleFluidItem, TabsSubtleFluidPanel };
export type {
