...
const ThinkingIndicatorFluid = forwardRef<
  HTMLDivElement,
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      role="status"
      data-slot="thinking-indicator-fluid"
    ...
    >
      ...
      >
        <span
          className="col-start-1 row-start-1 invisible thinking-shimmer-text"
          aria-hidden="true"
        >
        ...
        <AnimatePresence mode="popLayout" initial={false}>
          <motion.span
            key={words[index]}
            className="col-start-1 row-start-1 thinking-shimmer-text"
...
ThinkingIndicatorFluid.displayName = "ThinkingIndicatorFluid";

export { ThinkingIndicatorFluid };
