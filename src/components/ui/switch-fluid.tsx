...
interface SwitchFluidProps extends HTMLAttributes<HTMLDivElement> {
  label: string;
  checked: boolean;
  onToggle: () => void;
  disabled?: boolean;
...
const SwitchFluid = forwardRef<HTMLDivElement, SwitchFluidProps>(
...
SwitchFluid.displayName = "SwitchFluid";

export { SwitchFluid };
export type { SwitchFluidProps };
