...
const InputCopyFluid = forwardRef<HTMLDivElement, InputCopyFluidProps>(
  (
...
InputCopyFluid.displayName = "InputCopyFluid";

export { InputCopyFluid };
export type { InputCopyFluidProps };
