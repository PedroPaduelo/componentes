...
const AccordionGroup = forwardRef<HTMLDivElement, AccordionGroupProps>(
  (props, ref) => {
    ...
    // Strip non-HTML props before spreading them onto the host <div>.
    const restCopy: Record<string, unknown> = { ...rest };
    delete restCopy.value;
    delete restCopy.defaultValue;
    delete restCopy.onValueChange;
    delete restCopy.collapsible;
    delete restCopy.type;
    const htmlProps = restCopy as HTMLAttributes<HTMLDivElement>;
      ...
      >
        <AccordionPrimitive.Root {...radixProps} asChild>
          <div
            ...
            data-slot="accordion-group-fluid"
            className={cn(
