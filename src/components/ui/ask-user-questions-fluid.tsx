...
const AskUserQuestionsFluid = forwardRef<HTMLDivElement, AskUserQuestionsProps>(
  function AskUserQuestionsFluid(
    {
      questions,
    ...
    // Empty state — rendered after all hooks so hook order stays stable
    // across renders (rules-of-hooks). All the hooks above tolerate an
    // undefined `question` (options default to [], selections stay empty).
    if (!question) {
      return (
        <div
          ref={ref}
...
AskUserQuestionsFluid.displayName = "AskUserQuestionsFluid";
...
export { AskUserQuestionsFluid };
export default AskUserQuestionsFluid;
