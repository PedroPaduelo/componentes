...
/**
 * Cast helper para custom motion targets que carregam valores não cobertos
 * pela tipagem estrita do `TargetAndTransition` (ex.: a string `x` montada
 * via `calc(...)`). Double-cast tipado e seguro (TargetAndTransition).
 */
const asMotion = (vars: Record<string, string | number>): TargetAndTransition =>
  vars as unknown as TargetAndTransition
