...
// `defaultValue` is intentionally omitted from the public props: it collides
// with the native HTMLAttributes `defaultValue` and is not part of this
// component's controlled/uncontrolled API (driven by `open`/`defaultOpen`).
          ...
          <div className="flex-1 flex flex-col gap-1 min-w-0">
            <span
              className={cn(
                ...
                isActive && "thinking-shimmer-text"
              )}
...
function ThinkingStepSource({
  ...
  return (
    ...
    >
      <BadgeFluid variant="solid" size="sm" color={color} className={className}>
        {children}
      </BadgeFluid>
    </motion.span>
  );
