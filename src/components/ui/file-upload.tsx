...
import { type FileUploadProps } from "@/components/ui/file-upload-types"
...
/**
 * Componente FileUpload do Aceternity UI. Aceita drop de arquivos
 * (via `react-dropzone`) e clique no container (via input nativo).
 *
 * Visual: grid de pontos no fundo, ícone de upload central, lista
 * animada dos arquivos com `layoutId` para transição suave.
 */
...
/**
 * Grid decorativo de pontos usado como fundo do FileUpload.
 * Mantido como helper interno (não exportado) para evitar
