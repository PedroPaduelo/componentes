...
import { resolveCharset } from "./ascii-art-charsets"
import type { AsciiArtProps } from "./ascii-art-types"
...
/** MATRIX_CHARSET deve ficar ANTES do componente (hoisting). */
  ...
  if (animationStyle === "fade" && animated && !hasAnimated) {
    return (
      <motion.div
        ...
        data-slot="ascii-art"
        {...(hostProps as React.ComponentPropsWithoutRef<typeof motion.div>)}
      >
        {canvasElement}
      </motion.div>
    )
