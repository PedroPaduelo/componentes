...
const TabsList = forwardRef<HTMLDivElement, TabsListProps>(
  ({ children, className, ...props }, ref) => {
    ...
    // Derive value order from children synchronously. Memoised on `children`
    // so its identity is stable between renders — lets it be a safe dependency.
