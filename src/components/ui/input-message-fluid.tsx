...
interface InputMessageFluidProps
...
function FilePreviewTile({ file, onRemove, size }: FilePreviewTileProps) {
  ...
  return (
    ...
    >
      <FileThumbnailFluid file={file} size={size} />
      <TooltipFluid content="Remove" side="top">
        <button
          type="button"
          onClick={(e) => {
            e.stopPropagation();
...
const InputMessageFluid = forwardRef<HTMLDivElement, InputMessageFluidProps>(
  (
    {
      value,
      onValueChange,
...
InputMessageFluid.displayName = "InputMessageFluid";

export { InputMessageFluid };
export type { InputMessageFluidProps, InputMessageSlotContext };
export default InputMessageFluid;
