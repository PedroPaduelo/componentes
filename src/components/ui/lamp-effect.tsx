...
export type LampContainerProps = React.HTMLAttributes<HTMLDivElement>

function LampContainer({ children, className, ...props }: LampContainerProps) {
  return (
    <div
      data-slot="lamp-effect"
      className={cn(
        "relative flex min-h-[32rem] w-full flex-col items-center justify-center overflow-hidden rounded-md bg-slate-950 z-0",
        className
      )}
      {...props}
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0">
        <motion.div
          ...
          style={{
            backgroundImage:
              "conic-gradient(from 70deg at center top, var(--color-cyan-500), transparent, transparent)",
          }}
        ...
        <motion.div
          ...
          style={{
            backgroundImage:
              "conic-gradient(from 290deg at center top, transparent, transparent, var(--color-cyan-500))",
          }}
